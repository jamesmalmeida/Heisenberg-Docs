...
% Sugestão: diagrama mostrando o usuário $\\rightarrow$ nó de login (heisenberg.cnpem.br) →
%           rede interna $\\rightarrow$ nós work0..work8
\begin{figure}[H]
  \centering
...
\begin{description}
  ...
  \item[Reset de senha:] \url{http://172.20.60.13}\\
