% =====================================================================
% ARQUIVADO EM 2026-08-26 --- NAO E MAIS A FONTE DO MANUAL.
%
% A fonte canonica passou a ser ../heisenberg_doc.html, e o PDF e gerado a
% partir dele. Todo o conteudo util deste .tex foi incorporado la (tutorial de
% Linux, cheatsheets, glossario, checklist, exemplos GROMACS/VASP/Python,
% variaveis de ambiente do Slurm, boas praticas).
%
% Por que a mudanca: manter .tex e .html em paralelo, os dois editados a mao,
% produziu tres commits so para reconciliar um com o outro
% ("Sync HTML with latest tex", "Sync HTML with PDF", "Fix rightarrow"). Alem
% disso nao ha engine LaTeX instalada no cluster (nem xelatex, nem lualatex,
% nem pdflatex), entao este arquivo nao pode sequer ser compilado aqui.
%
% Este arquivo fica como registro historico. NAO edite esperando que a mudanca
% apareca no manual publicado.
% =====================================================================
...
\begin{longtable}{ll}
  ...
  \texttt{--ntasks=1} & Número de tarefas (processos MPI) \\
  \texttt{--ntasks-per-node=1} & Tarefas por nó \\
...
\begin{lstlisting}[style=terminal]
$ srun --partition=cpu --ntasks=4 --mem=8G \
